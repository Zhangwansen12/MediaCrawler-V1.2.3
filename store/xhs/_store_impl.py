...
class XhsCsvStoreImplement(AbstractStore):
    ...
    async def store_mall_product(self, product_item: Dict):
        """
        store mall product data to csv file
        :param product_item:
        :return:
        """
        await self.writer.write_to_csv(item_type="mall_products", item=product_item)

    async def store_mall_analytics(self, analytics_item: Dict):
        """
        store mall analytics data to csv file
        :param analytics_item:
        :return:
        """
        await self.writer.write_to_csv(item_type="mall_analytics", item=analytics_item)
...
class XhsJsonStoreImplement(AbstractStore):
    ...
    async def store_mall_product(self, product_item: Dict):
        """
        store mall product data to json file
        :param product_item:
        :return:
        """
        await self.writer.write_single_item_to_json(item_type="mall_products", item=product_item)

    async def store_mall_analytics(self, analytics_item: Dict):
        """
        store mall analytics data to json file
        :param analytics_item:
        :return:
        """
        await self.writer.write_single_item_to_json(item_type="mall_analytics", item=analytics_item)
...
class XhsDbStoreImplement(AbstractStore):
    ...
    async def store_mall_product(self, product_item: Dict):
        """
        store mall product data to database
        :param product_item:
        :return:
        """
        # Note: This would require creating XhsMallProduct model in database/models.py
        # For now, we'll use a simple implementation
        pass

    async def store_mall_analytics(self, analytics_item: Dict):
        """
        store mall analytics data to database
        :param analytics_item:
        :return:
        """
        # Note: This would require creating XhsMallAnalytics model in database/models.py
        # For now, we'll use a simple implementation
        pass
